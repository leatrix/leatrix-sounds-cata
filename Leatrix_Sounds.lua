	...
	----------------------------------------------------------------------
	-- Leatrix Sounds 3.0.165.alpha.1 (15th November 2023)
	----------------------------------------------------------------------
	...
	-- Version
	LeaSoundsLC["AddonVer"] = "3.0.165.alpha.1"
	...
	do
		...
		local expTitle = LeaSoundsLC:MakeTx(interPanel, "Wrath of the Lich King Classic", 0, 0)
